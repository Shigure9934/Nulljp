...
function Guide(){ 
    ...
    <div>
        ...
        <p className='text-sm px-8 pt-8'>
            ...
            or reading/watching content. Recommended dictionary tools are down below, more detailed explanation on
           ...
           <p className='px-8 inline-block underline hover:text-cyan-700'><a href='https://jisho.org/' target="_blank" rel="noreferrer" passHref>Jisho.org</a> </p>.
           <p className='px-8 inline- underline hover:text-cyan-700'><a href='https://foosoft.net/projects/yomichan/' target="_blank" rel="noreferrer" passHref>Yomichan</a> </p>.
